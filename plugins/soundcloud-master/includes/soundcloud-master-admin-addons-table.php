...
<table class="widefat" cellspacing="0">
	...
	<tbody>
		<tr class="alternate">
			<td style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-soundcloudmaster-widget-front-buttons.png', dirname(__FILE__)); ?>" alt="<?php echo get_option('soundcloud_master_name'); ?>" align="left" width="300px" height="139px" style="padding:5px;"/></td>
			...
			<td style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-check-yes.png', dirname(__FILE__)); ?>" alt="<?php echo get_option('soundcloud_master_name'); ?>" align="left" width="200px" height="121px" style="padding:5px;"/></td>
		</tr>
		<tr>
			<td style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-soundcloudmaster-widget-back-dashboard.png', dirname(__FILE__)); ?>" alt="<?php echo get_option('soundcloud_master_name'); ?>" align="left" width="300px" height="139px" style="padding:5px;"/></td>
			<td style="vertical-align:middle"><h3>Administrator Dashboard Widget</h3><p>Cool player widget to listen to your favourite Soundcloud Tracks while working on your Wordpress Administrator. Go to your Wordpress Dashboard page and start using it!!!</p></td>
			<td style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-check-'.$soundcloud_master_addon.'.png', dirname(__FILE__)); ?>" alt="<?php echo get_option('soundcloud_master_name'); ?>" align="left" width="200px" height="121px" style="padding:5px;"/></td>
		</tr>
		<tr class="alternate">
			<td style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-soundcloudmaster-widget-front-profile.png', dirname(__FILE__)); ?>" alt="<?php echo get_option('soundcloud_master_name'); ?>" align="left" width="300px" height="139px" style="padding:5px;"/></td>
		...
		<tr>
			<td style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-soundcloudmaster-widget-front-basic.png', dirname(__FILE__)); ?>" alt="<?php echo get_option('soundcloud_master_name'); ?>" align="left" width="300px" height="139px" style="padding:5px;"/></td>
		...
		<tr class="alternate">
			<td style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-soundcloudmaster-widget-front-advanced.png', dirname(__FILE__)); ?>" alt="<?php echo get_option('soundcloud_master_name'); ?>" align="left" width="300px" height="139px" style="padding:5px;"/></td>
		...
		<tr>
			<td style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-soundcloudmaster-shortcode-admin-in.png', dirname(__FILE__)); ?>" alt="<?php echo get_option('soundcloud_master_name'); ?>" align="left" width="300px" height="139px" style="padding:5px;"/></td>
			<td style="vertical-align:middle"><h3>Individual Shortcode</h3><p>Soundcloud Master uses TechGasp Wordpress Framework. The <b>Individual Shortcode</b> allows you to have a different customized Soundcloud Player in each page or post. Easy to use it can be found when you edit a page or a post under the wordpress text editor. Once you have created your shortcode, Just insert the shortcode <b>[soundcloud-master]</b> anywhere inside that text.</p></td>
			<td style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-check-'.$soundcloud_master_addon.'.png', dirname(__FILE__)); ?>" alt="<?php echo get_option('soundcloud_master_name'); ?>" align="left" width="200px" height="121px" style="padding:5px;"/></td>
		</tr>
		<tr class="alternate">
			<td style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-soundcloudmaster-shortcode-admin-un.png', dirname(__FILE__)); ?>" alt="<?php echo get_option('soundcloud_master_name'); ?>" align="left" width="300px" height="139px" style="padding:5px;"/></td>
		...
		<tr>
			<td style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-soundcloudmaster-updater-admin.png', dirname(__FILE__)); ?>" alt="<?php echo get_option('soundcloud_master_name'); ?>" align="left" width="300px" height="139px" style="padding:5px;"/></td>
		...
		<tr class="alternate">
			<td style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-soundcloudmaster-admin-addons-support.png', dirname(__FILE__)); ?>" alt="<?php echo get_option('soundcloud_master_name'); ?>" align="left" width="300px" height="139px" style="padding:5px;"/></td>
